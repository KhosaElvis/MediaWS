...
namespace MediaWS.Controllers
{
    public class UsersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,name,surname,email,password,confirm,dateOfbirth")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,name,surname,email,password,confirm,dateOfbirth")] User user)
        {
            if (ModelState.IsValid)
            {
